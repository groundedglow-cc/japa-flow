...
import { lesson14ImageCrops } from "./lesson14-image-crops";
...
const crop = (id: string) => lesson14ImageCrops.assets.find((asset) => asset.id === id)!;
...
const activities: PracticeActivity[] = [
  {
    ...
    assets: [crop("l14-p1-a1-te-form-pictures")],
  ...
  },
  {
    ...
    answerUnit: "sentence",
    responseScope: "sentence_only",
    assets: [crop("l14-p1-a4-direction-pictures")],
  ...
  },
  {
    ...
    assets: [crop("l14-p2-a3-listening-choice-pictures")],
