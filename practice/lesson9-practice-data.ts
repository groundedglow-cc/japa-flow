...
import { lesson9ImageCrops } from "./lesson9-image-crops";
...
const crop = (id: string) => lesson9ImageCrops.assets.find((asset) => asset.id === id)!;
...
const activities: PracticeActivity[] = [
  {
    ...
    assets: [crop("l9-p1-a1-picture-prompts")],
  ...
  },
  {
    ...
    answerUnit: "sentence",
    responseScope: "sentence_only",
    assets: [crop("l9-p1-a4-adjective-picture-prompts")],
  ...
  },
  {
    ...
    assets: [crop("l9-p2-a3-listening-picture-prompts")],
