...
const activities: PracticeActivity[] = [
  ...
  },
  {
    ...
    layout: [], itemGroups: [
      { id: "l34-p1-a6-g1", example: { label: "[例 1]", formatHints: { speakerLabels: ["甲", "乙", "甲", "乙"], speakerSentenceCounts: [1, 1, 1, 1] }, pairedRows: [
        { before: [text("甲 （句式 1）"), text("窓を開けます", { kana: "まどをあけます" })], after: [text("あのう、この窓を開けておいてもいいですか。", { kana: "あのう、このまどをあけておいてもいいですか。" })] },
        { before: [text("　　（句式 2）"), text("窓を閉めません", { kana: "まどをしめません" })], after: [text("あのう、この窓を閉めておかなくてもいいですか。", { kana: "あのう、このまどをしめておかなくてもいいですか。" })] }
      ], after: [text("乙：ええ。そのままにしておいてください。\n甲：じゃあ、お先に失礼します。\n乙：お疲れ様でした。", { kana: "おつ：ええ。そのままにしておいてください。\nこう：じゃあ、おさきにしつれいします。\nおつ：おつかれさまでした。" })] }, items: [
